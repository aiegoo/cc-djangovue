...
export SENTRY_PROJECT=django_vue-frontend
export VERSION=0.1
sentry-cli releases new "django_vue-frontend@$VERSION"
sentry-cli releases files "django_vue-frontend@$VERSION" upload-sourcemaps frontend/dist/js/
sentry-cli releases finalize "django_vue-frontend@$VERSION"
